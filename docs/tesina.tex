...
\textbf{Operazioni}
Il linguaggio consente le seguenti operazioni[...] tabella~\ref{table:operatori}
	...
	\begin{tabular}{|c|c|c|c|c|c|c|}
		...
		V1\textbackslash V2 &        int         &    real     &  string  & address & device & list \\ \hline
		      ...
		      device        &                    &             &          &         &  CMP   &      \\ \hline
		       list         &                    &             &          &         &        &  +   \\ \hline
	\end{tabular}
	\caption{Operazioni consentite dal linguaggio, sono da intendersi come V1 <operazione> V2. Con CMP si indicano le operazioni di comparazione ==, !=, >, >=, <, <=}
